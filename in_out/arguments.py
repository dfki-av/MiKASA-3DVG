...
def parse_arguments(notebook_options=None):
    ...
    #
    parser.add_argument('-scannet-file', type=str, help='pkl file containing the data of Scannet'
                                                                       ' as generated by running XXX')
    parser.add_argument('-referit3D-file', type=str)
    ...
    parser.add_argument('--objEnc-path', type=str, help='objEnc to resume')
    ...
    parser.add_argument('--max-test-objects', type=int, default=51)

    #
    # Training arguments
    #
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'evaluate', 'vis'])
    parser.add_argument('--max-train-epochs', type=int, default=200, help='number of training epochs. [default: 100]')
