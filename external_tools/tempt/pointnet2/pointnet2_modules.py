...
from referit3d.external_tools.pointnet2.pointnet2_utils import gather_operation,\
    furthest_point_sample, QueryAndGroup, GroupAll, three_nn, three_interpolate
...
class PointnetSAModuleVotes(nn.Module):
    ...
    def forward(self, xyz: torch.Tensor,
        ...
        # print("inds = ", inds.shape)  # [b, 2048]
        # print("xyz_flipped = ", xyz_flipped.shape)  # [b, 3, 40000]
        new_xyz = gather_operation(
            xyz_flipped, inds
        ).transpose(1, 2).contiguous() if self.npoint is not None else None
        # print("new_xyz = ", new_xyz.shape)  # [2, 2048, 3]
        ...
        # print("xyz = ", xyz.shape)  # [b, 40000, 3]
        # print("new_xyz = ", new_xyz.shape)  # [b, 2048, 3]
        # print("features = ", features.shape)  # [b, 4, 40000]
        # print("grouped_xyz = ", grouped_xyz.shape)  # [b, 3, 2048, 64]
        # print("grouped_features = ", grouped_features.shape)  # [b, 7, 2048, 64]
        ...
        # print("new_xyz = ", new_xyz.shape)  # [b, 2048, 3]
        # print("new_features = ", new_features.shape)  # [b, 128, 2048]
        # print("inds = ", inds.shape)  # [b, 2048]
        if not self.ret_unique_cnt:
